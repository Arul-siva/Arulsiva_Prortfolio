        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="relative w-[360px] h-[360px] lg:w-[460px] lg:h-[460px]">
              {/* Outer dotted ring */}
              <div className="absolute inset-0 rounded-full border border-accent/40 border-dashed animate-spin" style={{ animationDuration: '20s' }}></div>

              {/* Inner solid ring */}
              <div className="absolute inset-4 rounded-full border-[1px] bg-accentclient animate-spin" style={{ animationDuration: '20s', animationDirection: 'reverse' }}></div>
          ...
          >
            ...
            <div className="relative pl-6 mb-10">
              ...
              <p className="text-xl lg:text-2xl text-gray-300 font-medium leading-relaxed">
                “Building modern, responsive web applications with attention to performance and usability.”
              </p>
            </div>

            {/* Description */}
            <div className="space-y-6 text-gray-400 leading-relaxed mb-12">
             <p>I’m a software engineer focused on developing reliable applications with clear architecture and thoughtful implementation. I enjoy solving technical challenges and contributing to products that are stable, efficient, and easy to use.</p>
            </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <defs>
                          ...
                          >
                            <stop stop-color="#F0FF6C"></stop>
                            <stop offset="1" stop-color="#6BFDD9"></stop>
                          </linearGradient>
                          <linearGradient
