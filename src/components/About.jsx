...
import { Calendar, GraduationCap, MapPin, ShieldCheck, Star, X } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed mb-12">
              <p>
               I'm a Software Engineer specializing in React.js and PHP, with experience in building modern web applications from front-end to backend. I focus on writing clean, structured code and developing solutions that are reliable and easy to maintain.
              </p>
              <p>I enjoy solving technical problems, improving performance, and creating user-friendly applications that deliver a smooth and efficient experience.</p>
              
              <div className="bg-gradient-to-r from-accent/10 to-teal-400/10 border border-accent/20 rounded-xl p-3 mt-6">
                <div className="flex items-start gap-2">
                  <span className="text-2xl"></span>
                  <div>
                    <h4 className="text-white font-semibold mb-2">AI-Accelerated Development</h4>
                    <p className="text-sm text-gray-300">
                      I actively use <span className="text-accent font-medium">Cursor, GitHub Copilot, Codex, and Claude</span> daily to accelerate code delivery, automate repetitive tasks, and maintain high code quality standards—delivering projects faster without compromising reliability.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div  
                ...
                className="flex-1 bg-secondary2 border border-accent/20 rounded-3xl px-8 py-6 cursor-pointer hover:border-accent/40 hover:bg-accent/5 transition-all group"
                >
                <div className="flex items-center justify-center gap-3">
                  <GraduationCap className="text-accent group-hover:scale-110 transition-transform" size={24} />
                  <p className="text-lg font-semibold text-white">Education</p>
                </div>
              </div>
              <div
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <p className="text-lg font-semibold text-white">Certificate</p>
                </div>
              </div>
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="relative max-w-2xl w-full bg-[#102b2f] rounded-3xl border border-accent/30 p-8 shadow-2xl"
            >
              <button
                onClick={() => setIsModalOpen(false)}
              ...
              {education.map((item) => (
                <div key={item.id} className="space-y-4">
                  <div className="border-t border-white/10 pt-6">
                    <p className="text-sm uppercase tracking-widest text-accent mb-2">Degree</p>
                    <h4 className="text-xl font-bold text-white mb-3">{item.degree}</h4>
                    <p className="text-lg text-gray-300 mb-4">{item.institution}</p>
